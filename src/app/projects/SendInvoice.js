...
export class SendInvoice extends React.Component{
  render() {
    return(
      <div className={displayContainer}>
<p className={pageHeading}>Invoice<span className={floatRight}> <Icon icon={search} /> <Icon icon={glass2} /></span></p>
...
<thead>
  ...
  <tbody>
     <tr>
       ...
       <Link to="/createInvoice" className={hyperLink}>Create Invoice</Link></Button>
