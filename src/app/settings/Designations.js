...
import {displayContainer,pageHeading,hrStyle,labelStyle,inputstyle,formStyle,inputStyle,textAreaStyle,
  ...
  radioStyle,labelStyleRadio,imageInput,iconStyle} from "./LayoutSettings.css";

export class Designations extends React.Component{
  render() {
    return(
      <div className={displayContainer}>
<p className={pageHeading}>Designation Details</p>
