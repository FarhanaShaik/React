...
export class RolesAndPermissions extends React.Component{
  render() {
    return(
      <div className={displayContainer}>
<p className={pageHeading}>Roles & Permissions<span className={floatRight}><Icon icon={search} /></span></p>
...
<thead>
  ...
  <tbody>
     ...
     <tr>
       ...
       <Link to="/AddRole" className={hyperLink}>Add New Role</Link></Button>
      </div>
    );
  }
}
